        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <a class="col-lg-offset-5 btn btn-success" href="{{route('tag.create')}}">Add Tag</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <form display:none id="delete-form-{{$tag->id}}" method="post" action="{{route('tag.destroy',$tag->id)}}";> 
                      {{csrf_field()}}
                      {{method_field('Delete')}}
